...
class GetChatsDataManager{
    func getChats(_ pageIndex : Int, _ size : Int, _ viewController : UIViewController, _ completion: @escaping (_ data : [GetChatResult]) -> Void){
        ...
        AF.request("\(Constant.BASE_URL)/chats", method: .get ,encoding: JSONEncoding.default, headers: headers)
            .responseDecodable(of: GetChatModel.self){response in
